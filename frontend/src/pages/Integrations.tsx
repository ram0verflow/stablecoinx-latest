...
export const Integrations: React.FC = () => {
  ...
  const rows = [
    { name: 'Compliance Provider', purpose: 'KYC / sanctions / issuer risk', icon: <IcShield />, status: 'not_connected', detail: 'Local deterministic provider · no external compliance API wired yet', env: 'Sandbox' },
    { name: 'Wallet Intelligence', purpose: 'On-chain risk scoring & screening', icon: <IcPolicies />, status: stats.neo4j_status ? 'live' : 'degraded', detail: stats.neo4j_status ? 'Neo4j connected' : 'Neo4j unavailable', env: 'Production' },
